...
const Cards = ({ icon, text, description }: CardsProps) => {
  return (
    <div className="m-2.5 md:mx-0 md:w-[300px] md:h-[260px] relative rounded-tl-3xl rounded-br-3xl bg-white flex flex-col items-center shadow-2xl md:-mt-14 mb-16">
