...
const Footer = () => {
  return (
    <footer className="w-full mt-12 bg-dark-gray grid lg:grid-cols-3 content-center text-white/50 p-12">
      <div className="flex flex-col justify-center items-center text-center mb-5 lg:block lg:m-0">
        <Link href="#home">
          <Image src={logo} width={180} alt="Logo" />
        </Link>
        <p className="font-light lg:max-w-[60%] text-justify">
        ...
        <div className="flex flex-col lg:flex lg:text-left">
      ...
      <div className="mb-7 lg:mb-0 flex flex-col items-center text-center lg:items-start lg:text-left">
      ...
      <div className="flex flex-col gap-9 items-center text-center lg:items-start lg:text-left lg:mb-0">
        <div>
